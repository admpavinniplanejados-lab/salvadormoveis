  ...
  return (
    <main>
      ...
      <div className="top-promo-bar">
        <div className="container top-promo-bar-inner">
          <div className="promo-item">
            ...
            <span>Entrega 24h a 72h para Salvador, Lauro e região (Consulte Condições)</span>
          </div>
          <div className="promo-item">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="container header-inner">
          ...
          <div className="header-actions">
            <Link href="/login" className="header-action">
              ...
              <span className="action-text">Atendimento</span>
            </Link>
            <Link href="/rastreamento" className="header-action">
              <svg className="action-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="1" y="3" width="15" height="13" rx="2" ry="2" />
                <polygon points="16 8 20 8 23 11 23 16 16 16" />
                <circle cx="5.5" cy="18.5" r="2.5" />
              ...
              <span className="action-text">Rastrear<br />pedido</span>
            </Link>
            <Link href="/login" className="header-action">
              <svg className="action-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="action-text">Minha...</span>
            </Link>
      ...
      <nav className="category-nav" id="category-nav">
        <div className="container category-nav-inner">
          <ul className="cat-list" id="cat-list">
            <li><Link href="/produtos">SOFÁS</Link></li>
            <li><Link href="/produtos">ROUPEIROS</Link></li>
            <li><Link href="/produtos">MESA</Link></li>
            <li><Link href="/produtos">CÔMODAS</Link></li>
            <li><Link href="/produtos">COLCHÕES E CAMAS BOX</Link></li>
            <li><Link href="/produtos">MAIS CATEGORIAS</Link></li>
          </ul>
      ...
      <section className="promo-strip">
        <div className="container promo-strip-inner">
          <div className="promo-strip-item">
            <div className="promo-strip-icon">
            ...
            <div className="promo-strip-text">
              ...
              <span>consulte a aba de promoção</span>
            </div>
          </div>
          <div className="promo-strip-item">
            <div className="promo-strip-icon">
          ...
          <div className="promo-strip-item">
            ...
            <div className="promo-strip-text">
              <strong>PARCELE ATÉ 10X S/ JUROS</strong>
              <span>nos cartões</span>
            </div>
          </div>
          <div className="promo-strip-item">
            <div className="promo-strip-icon">
      ...
      <section className="cat-icons-section">
        <div className="container">
          <div className="cat-icons-grid">
            <Link href="/produtos" className="cat-icon-item">
      ...
      <footer className="footer">
        ...
        <div className="container">
          <div className="footer-main">
            ...
            <div className="footer-left">
              ...
              <p className="footer-description">
                Salvador Móveis – Transformando Sonhos! Oferecemos móveis de qualidade, conforto e elegância. 
                Cada peça é pensada para refletir seu estilo e tornar seus ambientes ainda mais especiais. 
            ...
            {/* Middle Section: Institutional */}
            <div className="footer-section">
              <h4 className="footer-section-title">INSTITUCIONAL</h4>
              <ul className="footer-links">
                <li><Link href="/como-comprar">Como comprar</Link></li>
                <li><Link href="/seguranca">Segurança</Link></li>
                <li><Link href="/nossas-lojas">Nossas Lojas</Link></li>
                <li><Link href="/meios-pagamento">Meios de pagamento</Link></li>
                ...
                <li><Link href="/regulamento">Regulamento Placar-Premiado</Link></li>
                <li><Link href="/cupons">Cupons de desconto</Link></li>
            ...
            <div className="footer-section">
              ...
              <div className="attendance-item">
                ...
                <div className="attendance-content">
                  <p className="attendance-label">Endereço</p>
                  <p className="attendance-value">Rua Cristiano Buys, 122 f<br/>Loja Horto Bela Vista<br/>Salvador - BA | CEP: 41150-120</p>
                </div>
              </div>
              ...
              <div className="attendance-item">
                <span className="attendance-icon">💬</span>
                <div className="attendance-content">
                  <p className="attendance-label">WhatsApp</p>
                  <p className="attendance-value">
                    <a href="https://api.whatsapp.com/send?phone=557191770157" target="_blank" rel="noopener noreferrer">(71) 9177-0157</a>
                  </p>
                </div>
              </div>
              ...
              <div className="attendance-item">
                ...
                <div className="attendance-content">
                  <p className="attendance-label">E-mail</p>
                  <p className="attendance-value"><a href="mailto:salvadormoveisbahia@gmail.com">salvadormoveisbahia@gmail.com</a></p>
                </div>
              </div>
            ...
            <div className="footer-section">
              ...
              <div className="payment-methods">
                <span className="payment-method">💳 Crédito</span>
                <span className="payment-method">💳 Débito</span>
                <span className="payment-method">🔷 PIX</span>
                <span className="payment-method">📋 Carnê</span>
              </div>
          ...
          <div className="footer-bottom">
            <p>&copy; 2024 Salvador Móveis. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </main>
